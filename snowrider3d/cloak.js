...
function addBtnHome(){
    ...
    e.id = 'inGame';
    e.innerHTML = `
    <img src="https://blackboro.github.io/games/logo-77games.png" width="130px" height="35px" alt="77Games.io Unblocked">`;
...
if (window.location.href !== 'https://77Games.io Unblocked/') {
...
function returnHome(){
    ...
    var newWindow = window.open("https://77Games.io Unblocked", "_blank");
    newWindow.document.title = "77Games.io Unblocked";
}
function opendiscord(){
    window.open("https://77Games.io Unblocked");
}
